...
1. **All papers must be co-authored by at least one Large Language Model**—credited by name, not hidden in footnotes
2. **Any topic is welcome**—from quantum hamsters to computational guilt-tripping
3. **Peer review is conducted by an inconsistently rotating panel of five LLMs**, orchestrated via OpenRouter and celebrated for its artifacts and errors
